...
from odoo17e.odoo.tools.safe_eval import safe_eval
...
class PlayGround(models.Model):
    ...
    # - self:current object
    # - self.env:odoo Environment on witch the action is triggered
    ...
    model_id = fields.Many2many('ir.model', string='Model')
